...
class LoginViewTest(TestCase):
    ...
    def test_login_successful_with_valid_credentials(
        self, mock_token_serializer, mock_authenticate, mock_login_serializer
    ):
    ...
    @patch("api.views.auth.authenticate")
    @patch("api.views.auth.CustomTokenObtainPairSerializer")
    def test_login_token_serializer_invalid(
        self, mock_token_serializer, mock_authenticate, mock_login_serializer
    ):
...
class RegisterViewTest(TestCase):
    ...
    @patch("api.views.auth.CustomTokenObtainPairSerializer")
    def test_register_successful_with_valid_data(
        self, mock_token_serializer, mock_create_user, mock_register_serializer
    ):
    ...
    @patch("api.views.auth.User.objects.create_user")
    @patch("api.views.auth.CustomTokenObtainPairSerializer")
    def test_register_token_generation_logic(
        self, mock_token_serializer, mock_create_user, mock_register_serializer
    ):
        ...
        expected_token_data = {"email": "test@example.com", "password": "testpassword"}
