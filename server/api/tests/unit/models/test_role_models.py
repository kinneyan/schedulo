...
class MemberRoleModelTest(TestCase):
    ...
    def test_member_can_have_multiple_roles(self):
        ...
        member_role1 = MemberRole.objects.create(
            workspace_role=self.role,
            member=self.member
        )
        member_role2 = MemberRole.objects.create(
            workspace_role=role2,
            member=self.member
        )
