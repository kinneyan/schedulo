...
class Shift(models.Model):
    ...
    created_by = models.ForeignKey(WorkspaceMember, on_delete=models.CASCADE, related_name='created_shifts')
    open = models.BooleanField(default=False)

class ShiftRequest(models.Model):
    date_created = models.DateTimeField(auto_now_add=True)
    date_modified = models.DateTimeField(auto_now=True)
    sender = models.ForeignKey(WorkspaceMember, on_delete=models.CASCADE, related_name='sent_shift_requests')
    recipient = models.ForeignKey(WorkspaceMember, on_delete=models.CASCADE, related_name='received_shift_requests')
...
class TimeOffRequest(models.Model):
    ...
    approved_by = models.ForeignKey(WorkspaceMember, on_delete=models.CASCADE, related_name='approved_time_off_requests', null=True, blank=True)
